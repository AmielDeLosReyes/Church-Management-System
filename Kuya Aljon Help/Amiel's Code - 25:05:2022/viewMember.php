...
<div id="addtoministrymodal" class="modal">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <!-- TO DO: LISTING OF MINISTRIES HERE -->

            <!-- TO DO: iterate through ci_ministry to print out ministries name -->
          <div>
            <div class="list-group">
              <a href="#" class="list-group-item list-group-item-action active">MAN</a>
              <a href="#" class="list-group-item list-group-item-action">SAN</a>
              <a href="#" class="list-group-item list-group-item-action">WAN</a>
          ...
          <!-- Proceed and Cancel Button -->
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-indigo" onclick="location.href = '<?php echo base_url(); ?>Members/addToMinistry/<?php echo $selectedMinistryId; ?>'">Proceed</button>
                <button type="button" class="btn btn-outline-light" data-bs-dismiss="modal">Close</button>
            </div>
