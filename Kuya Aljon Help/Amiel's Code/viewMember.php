    ...
    <div class="container">  
      ...
      <!--                <a href=""><i class="typcn typcn-camera-outline"></i></a>-->
                    ...
                    <div class="media-body">
                        ...
                        <p><?php echo $selectedMember->NETWORK . ' ' . "Network" ?></p>
                        <nav class="nav">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div>
                                ...
                                <span class="tx-medium"><?php echo $selectedMember->CONTACT_NUMBER; ?></span>
                            </div>
                        </div><!-- media-body -->
                    </div><!-- media -->
                    <div class="media">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div>
                                ...
                                <span class="tx-medium"><?php echo $selectedMember->ADDRESS; ?></span>
                            </div>
                        </div><!-- media-body -->
                    </div><!-- media -->
                    <div class="media">
                        <div class="media-icon"><i class="fas <?php echo ($selectedMember->GENDER == 'MALE') ? 'fa-male' : 'fa-female'; ?>"></i></div>
                        <div class="media-body">
                            <div>
                                <label>Gender</label>
                                <span class="tx-medium"><?php echo $selectedMember->GENDER ?></span>
                            </div>
                        </div><!-- media-body -->
                    </div><!-- media -->
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div>
                                ...
                                <span class="tx-medium"><?php echo date("F j, Y", strtotime($selectedMember->BIRTHDATE)); ?></span>
                            </div>
                        </div><!-- media-body -->
                    </div><!-- media -->
...
<div id="addtoministrymodal" class="modal">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Which ministry would you like to add  <?php echo $selectedMember->FIRST_NAME . " " . $selectedMember->LAST_NAME ?>? </p>
            </div>

          <!-- Listing the ministries -->
          ...
          <div>
            <div class="list-group">
                ...
                foreach ($ministries as $ministry):
                    ...
                    ?>
                    <div class="list-group-item list-group-item-action <?php if ($selectedId == $ministry->MINISTRY_ID) echo 'selected'; ?>" onclick="location.href = '<?php echo base_url(); ?>Members/ViewMinistry/<?php echo $ministry->MINISTRY_ID ?>'">

                <?php endforeach; ?>

                <!-- end of printing --> 

              <a href="#" class="list-group-item list-group-item-action active">Multimedia Arts Network</a>
    
              <a href="#" class="list-group-item list-group-item-action">Services Auxiliary Network</a>
              <a href="#" class="list-group-item list-group-item-action">Worship and Arts Network</a>
