...
<div id="addtoministrymodal" class="modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <form method="POST" action="<?php echo base_url(); ?>Members/addToMinistry/<?php echo $selectedMember->MEMBER_ID; ?>" data-parsley-validate>
            <div class="modal-header">
            ...
            <div class="modal-body">
                <h6>Which ministry would you like to add  <?php echo $selectedMember->FIRST_NAME . " " . $selectedMember->LAST_NAME ?>?</h6>
