            ...
            <div class="az-contact-info-header">
                <div class="media">            
                    <div class="az-contact-action">
                                ...
                                <a href="" data-bs-toggle="modal" data-bs-target=""><i class="fas fa-solid fa-file-excel"></i>Excel</a>
                                    ...
                                    <br>
                                        ...
                                        <label class="form-label">Gender: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Network:</label>
                                            ...
                                            <div class="col-lg">
                                                ...
                                                <select id="gender" name="gender" class="form-control select2-no-search" data-parsley-class-handler="#genderWrapper" data-parsley-errors-container="#genderErrorContainer" style="width: 270px;">
                                                        <option label="Choose one"></option>
                                        ...
                                        <br>
                                            <!-- Address -->
                                            <div class="col-lg mg-t-10 mg-lg-t-0">
                                                <select id="network" name="network" class="form-control select2-no-search" data-parsley-class-handler="#networkWrapper" data-parsley-errors-container="#networkErrorContainer" style="width: 266px;">
                                                        <option label="Choose one"></option>
