            ...
            <form method="POST" action="<?php echo base_url(); ?>Ministries/save/<?php echo $selectedMinistry->MINISTRY_ID; ?>" data-parsley-validate>
                ...
                <div class="row row-sm wd-400">
                    <div class="col-lg mg-t-10 mg-lg-t-0">
                        <input placeholder="(000) 000-0000" id="phoneMask" class="form-control" placeholder="Contact Number" type="text" value="<?php echo $selectedMinistry->ABBREVIATION; ?>" name="contactNum">
                    </div>
                </div> --> 
                ...
                <div class="az-content-label mg-b-5">Number Of Members</div>

                <div class="row row-sm mg-t-20">
                    <div class="col-lg">
                        <textarea name ="numOfMembers" rows="3" class="form-control" placeholder="Number Of Members"></textarea>
                    </div>
                </div>
                ...
                <div class="row row-sm mg-t-20 wd-300">
                    <div class="col-lg">
                        <select name="ABBREVIATION" class="form-control select2-no-search" required>
                            <option label="Choose one"></option>
                            <option <?php if ($selectedMinistry->ABBREVIATION == 'MALE') echo 'selected'; ?> value="MALE">Male</option>
                            <option <?php if ($selectedMinistry->ABBREVIATION == 'FEMALE') echo 'selected'; ?> value="FEMALE">Female</option>
                        </select>
                    </div>
                </div> -->
<!-- 
                ...
                <div class="row row-sm mg-t-20 wd-450">
                    <div class="col-lg">
                        <select name="network" class="form-control select2-no-search" required>
                            <option label="Choose one"></option>
                            <option <?php if ($selectedMinistry->NETWORK == 'KIDDOS') echo 'selected'; ?> value="KIDDOS">Children (below 13 yrs. old)</option>
                            <option <?php if ($selectedMinistry->NETWORK == 'CYN') echo 'selected'; ?> value="CYN">CYN (13 to 22 yrs. old)</option>
                            <option <?php if ($selectedMinistry->NETWORK == 'YAN') echo 'selected'; ?> value="YAN">YAN (23 to 29 yrs. old)</option>
                            <option <?php if ($selectedMinistry->NETWORK == 'MEN') echo 'selected'; ?> value="MEN">Men (Adult Men, 30 yrs. old and above)</option>
                            <option <?php if ($selectedMinistry->NETWORK == 'WOMEN') echo 'selected'; ?> value="WOMEN">Women (Adult Women, 30 yrs. old and above)</option>
                        </select>
                    </div>
                </div> -->
                ...
                <div class="wd-200 mg-b-20">
                    <div class="input-group">
                        ...
                        <input name="birth_date" type="text" class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="<?php echo date("m/d/Y", strtotime($ministry->ABBREVIATION)); ?>">
                    </div>
                </div>
