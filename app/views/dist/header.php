...
<!--        <div class="az-navbar-header">
        ...
        <ul class="nav">
          ...
          <li class="nav-item active show">
            ...
            <ul class="nav-sub">
              <li class="nav-sub-item"><a href="<?php echo base_url(); ?>Members" class="nav-sub-link">Member Information</a></li>
          ...
          <li class="nav-item">
            <a href="" class="nav-link with-sub"><i class="typcn typcn-folder"></i>Reporting</a>
            <ul class="nav-sub">
              <li class="nav-sub-item">
                <a href="<?php echo base_url(); ?>Attendance" class="nav-sub-link">Attendance</a>
